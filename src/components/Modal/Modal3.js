...
export default function BasicModal() {
  ...
  const Rows= [
    {
    id: 1,
    LifterModel:"STD-Standard" ,
    PowerSource: "COMB-Combustion",
    WheelType: "c-Cushion",
    counterweig:"1.000 kg" ,
  },
  {
    id: 2,
    LifterModel:"HVY-Heavy" ,
    PowerSource: "COMB-Combustion",
    WheelType: "c-Cushion",
    counterweight:"2.000 kg" ,
  },
  {
    id: 3,
    LifterModel: "STD-Standard",
    PowerSource: "ELEC-Electrical",
    WheelType: "c-Cushion",
    counterweight:"1.000 kg" ,
  },
  {
    id: 4,
    LifterModel: "HVY-Heavy",
 ...
 const totalTable = () => {
    const datats = Rows.filter((row) => {
     if( row.LifterModel === value )
     return row;
     if( row.PowerSource === value )
     return row;
     if( row.WheelType === value )
     return row;
     if( row.counterweight === value )
     return row;
    });
    if(datats){    
    setData(datats);
